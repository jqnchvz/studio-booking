    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-16">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 text-center space-y-8">
        ...
        <div className="inline-flex items-center gap-2 bg-primary/10 text-primary text-xs font-medium px-3 py-1.5 rounded-full">
          ...
          <span>La plataforma de reservas para negocios locales</span>
        </div>
        ...
        <p className="text-lg sm:text-xl text-muted-foreground max-w-2xl mx-auto leading-relaxed">
          Reservapp te da todo lo que necesitas: reservas online, planes de suscripción,
          cobros automáticos con MercadoPago y un panel de control para gestionar tu negocio.
        </p>
