 ...
 * Owner Portal Layout
 *
 * Responsive sidebar layout for business owners. Desktop shows a fixed 264px
 * sidebar; mobile collapses it into a hamburger-triggered Sheet drawer.
 *
...
export default async function OwnerLayout({
  ...
  const brandInitial = org?.name?.[0]?.toUpperCase() ?? 'O';
  const brandName = org?.name ?? 'Mi Empresa';
